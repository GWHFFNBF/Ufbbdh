...
cmd({
  ...
  try {
    // 🔒 Protected numbers
    const protectedNumbers = ["923195068309", "923110741871", "923147168309", "923196891871"];
    ...
    if (protectedNumbers.includes(fetchedNumber)) {
      return reply("🚫 Access Denied! This number is protected by DOCTOR-MD Owner Security System.");
    }
